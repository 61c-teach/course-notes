...
We run our [DGEMM benchmark](#sec-dgemm-benchmark) from earlier, now with some of the optimizations described in this section.
...
### DGEMM 5: GCC optimizations

We ran the three programs above with different `gcc` optimization flags and report the results in @tab-dgemm-gcc.
