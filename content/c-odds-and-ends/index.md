...
:label: fig-bit-shift
:width: 50%
:alt: "Bitwise-AND operation between 0x000034FF and 0x0034FF00, producing 0x00003400. The the middle bytes are highlighted to show the bitwise-AND between bytes 0x34 and 0xFF where only overlapping 1 bits are kept."
