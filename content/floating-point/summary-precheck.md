...
Note that in the above table, our exponent has values from $0 $ to $255 $. When translating between
binary and decimal floating point values, we must remember that there is a bias for the exponent.
